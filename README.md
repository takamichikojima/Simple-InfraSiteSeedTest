...
インターネット上の速度テスト（例: `https://speedtest.example.com/`）で説明することもできますが、イントラネットでは経路が異なるため、社内専用の速度測定が必要なケースで特に有効です。

## 動作イメージ

<video controls width="720">
  <source src="docs/00_video.mp4" type="video/mp4">
  このブラウザーは動画再生に対応していません。`docs/00_video.mp4` を直接開いてください。
</video>
